...
<head>
    ...
    <title>Handphone - @yield('title', 'Website')</title>
...
<body>
    <nav class="navbar navbar-expand-lg bg-secondary" data-bs-theme="dark">
        <div class="container">
            <a class="navbar-brand" href="/">HANDPHONE</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="/handphones/data">MACAM DAN JENIS</a>
                        </li>
                    @endauth
                </ul>
    ...
    <footer class="bg-info text-center text-white py-2">
        Copyright &copy; 2023 by al khamni
    </footer>
